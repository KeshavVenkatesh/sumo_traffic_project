...
OD_EDGE_MOVEMENT_BALANCE_MAX_LEFT_SHARE = 0.45
OD_EDGE_MOVEMENT_BALANCE_MAX_RIGHT_SHARE = 0.55
OD_EDGE_MOVEMENT_BALANCE_RELAX_FRACTION = 0.85
...
OD_ACTIVE_APPROACH_MAX_SUCCESSOR_SHARE = 0.60
OD_ACTIVE_APPROACH_MAX_LEFT_SHARE = 0.52
OD_ACTIVE_APPROACH_MAX_RIGHT_SHARE = 0.62
OD_ACTIVE_APPROACH_MAX_STRAIGHT_SHARE = 0.78
OD_ACTIVE_APPROACH_RELAX_FRACTION = 0.72
...
OD_ZONE_GRID_LINE_THICKNESS = 35.0
OD_ZONE_GRID_LINE_COLOR = (0, 35, 255, 235)
OD_ZONE_GRID_BORDER_COLOR = (0, 0, 180, 255)
OD_ZONE_GRID_LINE_LAYER = 280
OD_ZONE_FILL_LAYER = 210
OD_ZONE_FILL_ALPHA = 72
OD_ZONE_FILL_COLORS = (
    (255, 80, 80),
    (255, 170, 60),
    (255, 235, 70),
...
def draw_od_zone_grid_lines(context, args):
    ...
    grid lines are drawn on top so the zones remain visible while zoomed out.
    """
    ...
    print()
    print("OD destination-zone GUI overlay:")
