...
- Source commit: `e02bb46eb4911fafb04c03c2b772bfd41a133ef6`
- Complete raw output: GitHub Release `detector-v4-heldout-results-20260910`
- Model checkpoints, map corpus, and training records: GitHub Release `detector-v4-trained-20260902`
- The 96 map/rate `paired_runs.csv` tables are included here for direct analysis.
- Per-job logs, generated demand, and redundant raw rows are kept out of Git history.
