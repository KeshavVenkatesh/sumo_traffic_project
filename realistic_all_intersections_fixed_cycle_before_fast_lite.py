...
OD_EDGE_MOVEMENT_BALANCE_RELAX_FRACTION = 0.98
...
OD_ACTIVE_APPROACH_MIN_SAMPLES = 8
OD_ACTIVE_APPROACH_MAX_SUCCESSOR_SHARE = 0.42
OD_ACTIVE_APPROACH_MAX_LEFT_SHARE = 0.35
OD_ACTIVE_APPROACH_MAX_RIGHT_SHARE = 0.45
OD_ACTIVE_APPROACH_MAX_STRAIGHT_SHARE = 0.70
OD_ACTIVE_APPROACH_RELAX_FRACTION = 0.98
...
OD_APPROACH_MAX_LEFT_SHARE = 0.40
OD_LEFT_BIAS_RELAX_AFTER_ATTEMPTS_FRACTION = 0.98
...
OD_APPROACH_TURN_CONTROL_ENABLED = True
