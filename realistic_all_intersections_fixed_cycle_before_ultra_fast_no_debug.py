...
OD_ACTIVE_APPROACH_BALANCE = True
OD_ACTIVE_APPROACH_MIN_SAMPLES = 12
OD_ACTIVE_APPROACH_MAX_SUCCESSOR_SHARE = 0.55
OD_ACTIVE_APPROACH_MAX_LEFT_SHARE = 0.45
OD_ACTIVE_APPROACH_MAX_RIGHT_SHARE = 0.55
OD_ACTIVE_APPROACH_MAX_STRAIGHT_SHARE = 0.70
...
OD_ZONE_GRID_LINES_ENABLED = True
OD_ZONE_COLOR_FILL_ENABLED = True
